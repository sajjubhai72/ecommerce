...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,FatherName,RollId,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:fathername,:roolid,:studentemail,:gender,:classid,:dob,:status)";
...
<div class="col-sm-10">
<input type="text" name="fatheranme" class="form-control" id="fatheranme" required="required" autocomplete="off">
</div>
</div>
