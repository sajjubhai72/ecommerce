...
$status=$_POST['status'];
$sql="update admission set Name=:tname,Email=:email,MobileNumber=:mobilenumber,Qualifications=:qualifications,Address=:address,TeacherSub= :tsubjects,JoiningDate=:joiningdate,description=:description,teachingExp=:teachexp,isPublic=:status where ID=:eid";
