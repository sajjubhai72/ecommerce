...
if ($_GET['delid']) {
    ...
    echo "<script>window.location.href ='nursery.php'</script>";
}
...
<head>
    <title>Manage Nursery Class</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Nursery Class</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="myTable" class="display responsive nowrap">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM admission WHERE s_class = 'Nursery'";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo htmlentities($row->s_photo); ?>" alt="Student Photo" style="width: 50px; height: 50px;"></td>
                                                ...
                                                <td><a href="edit-admission-form/edit-nursery.php?editid=<?php echo htmlentities($row->ID); ?>" class="btn btn-primary">Edit</a>
                                                    <a href="nursery.php?delid=<?php echo htmlentities($row->ID); ?>" class="btn btn-danger" onclick="return confirm('Do you really want to delete?');">Delete</a>
                                                </td>
                                            </tr>
                                    <?php $cnt = $cnt + 1;
                                        }
